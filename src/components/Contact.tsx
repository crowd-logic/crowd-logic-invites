  ...
  return (
    <section id="contact" className="relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[32rem] h-[32rem] bg-purple-500/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          <p className="text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed font-light">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-orange-400 font-semibold"> we'd love to connect </span>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-24">
          <div className="group relative">
            <div className="absolute -inset-2 bg-gradient-to-r from-purple-600 to-orange-600 rounded-3xl blur opacity-30 group-hover:opacity-75 transition duration-500"></div>
            <div className="relative bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-3xl p-10 h-full">
              <div className="mb-8">
                <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-orange-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="group relative">
            <div className="absolute -inset-2 bg-gradient-to-r from-orange-600 to-pink-600 rounded-3xl blur opacity-30 group-hover:opacity-75 transition duration-500"></div>
            <div className="relative bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-3xl p-10 h-full">
              <div className="mb-8">
                <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-pink-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
              ...
              <a 
                ...
                className="group/link inline-flex items-center space-x-3 text-orange-400 hover:text-orange-300 transition-colors text-lg font-semibold"
              >
                <span>connect@accesscrowdlogic.com</span>
                <ArrowRight className="w-5 h-5 group-hover/link:translate-x-2 transition-transform duration-300" />
              </a>

              <div className="absolute top-6 right-6 w-4 h-4 bg-orange-400 rounded-full animate-ping delay-500"></div>
            </div>
          </div>
        </div>
        ...
        <div className="relative mb-24">
          <div className="absolute inset-0 bg-gradient-to-r from-purple-900/20 via-orange-900/20 to-pink-900/20 rounded-3xl blur-xl"></div>
          <div className="relative bg-slate-900/60 backdrop-blur-2xl border border-white/20 rounded-3xl p-16 text-center">
            <div className="mb-8">
              ...
              <h3 className="text-4xl md:text-5xl font-black text-white mb-8">
                Be Part of the
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-orange-400"> Revolution</span>
              </h3>
            </div>
            ...
            <div className="flex justify-center items-center space-x-4 mb-8">
              ...
              <div className="w-16 h-px bg-gradient-to-r from-yellow-400 to-orange-400"></div>
              <div className="flex items-center space-x-2">
                <div className="w-4 h-4 bg-orange-400 rounded-full animate-pulse delay-700"></div>
                <span className="text-orange-400 font-semibold">Late 2025 Launch</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          <div className="text-center py-12 border-t border-white/10">
            ...
            <p className="text-gray-400 text-lg">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-orange-400 font-semibold"> Building the future of community engagement.</span>
            </p>
