      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-24">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-3xl p-10 h-full">
              <div className="mb-8">
                <div className="w-20 h-20 bg-gradient-to-br from-amber-500 to-cyan-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
